...
main(int argc, char *argv[])
{
    ...
    while ( (n = getopt(argc, argv, "T:UINs:h:d:p:q:l:x:t:")) != -1) {
        char *p;
        switch (n) {
            case 'T':
                switch (atoi(optarg)) {
...
usage(const char *argv0)
{
	printf("%s \n", banner);
        ...
        printf("    -T TCP   attack                     \e[1;37m[\e[0m0:ACK   1:PUSH\e[1;37m]\e[0m\n");
    ...
    printf("\e[1musage\e[0m: %s -U -N -T0 -T3 -h 8.8.8.8 -x5 -t100\n", argv0);
    exit(-1);
}